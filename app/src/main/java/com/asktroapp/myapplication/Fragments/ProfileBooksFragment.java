...
public class ProfileBooksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.profile_books_fragment, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.Profile_Recycler_view);

        booksList = new ArrayList<>();

        adapter = new ProfileBooksAdapter(getActivity(), booksList ,new CustomItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ProfileBooksDialogFragment dialogFragment = new ProfileBooksDialogFragment();
